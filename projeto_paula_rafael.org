...
Para chegar a tabela abaixo, usamos a função =time= englobando as implementações feitas com um vetor criado com a =create-vector=, este disponível na pasta /códigos/.
...
|--------------------------+-----+-------------+-------------+-------------+---------------|
|                          |     |             |             |             |               |
| Time to solve            | N^2 | 150 ms      | 4 ms        | 80 ms       | 4 ms          |
| problem of size          | N^3 | 2.5 min     | 400 ms      | 1.2 s       | 40 ms         |
|                          | N^4 | 41 hrs      | 40 s        | 16 s        | 0.4 s         |
|                          | N^5 | 4.8 yrs     | 6.6 min     | 3.3 min     | 4 s           |
|                          | N^6 | 4.8 mill    | 11.1 hrs    | 40 min      | 40 s          |
|--------------------------+-----+-------------+-------------+-------------+---------------|
|                          |     |             |             |             |               |
